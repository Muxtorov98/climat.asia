...
class SourceMessageController extends \backend\modules\settings\controllers\base\SourceMessageController
{
    ...
    public function actionList()
    {
        if (Yii::$app->request->post("hasEditable")) {
            ...
            $message = Message::find()->where(['id' => $id])->andWhere(['language' => $lang])->one();
            ...
            return ['output'=>$value, 'message'=>$message->getFirstError("translation"), 'code' => Yii::$app->response->statusCode];
        }
