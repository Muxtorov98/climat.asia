...
?>
<div class="giiant-crud product-categories-view">
    ...
    <h1>
        <?= Yii::t('models', 'Product Categories') ?>
        <small>
    ...
    <?php $this->beginBlock('common\models\ProductCategories'); ?>
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'content' => $this->blocks['common\models\ProductCategories'],
                    'active'  => true,
                ],
            ]
        ]
