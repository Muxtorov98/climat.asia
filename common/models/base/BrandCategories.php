...
/**
 * This is the base-model class for table "brand_categories".
 *
 * @property integer $id
 ...
 */
abstract class BrandCategories extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\BrandCategories the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\BrandCategories(get_called_class());
    }
